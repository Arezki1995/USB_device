...
const USB_Descriptor_Configuration_t PROGMEM RelayBoard_ConfigurationDescriptor =
{
	...
	.PAD_IN_Interface =
			...
			.InterfaceNumber        = INTERFACE_ID_PADIN,// what should we put here ? 
			.AlternateSetting       = 0,

			.TotalEndpoints         =2,

			.Class                  = USB_CSCP_VendorSpecificClass,// same question 
			.SubClass               = 0x00,
			.Protocol               = 0x00,
	...
	.PAD_OUT_Interface =
		{
			...
			.InterfaceNumber        = INTERFACE_ID_PADOUT, // what should we put here ? 
			.AlternateSetting       = 0,
	...
	.PAD_ReportINEndpoint1=
		{
			...
			.EndpointAddress        = PAD_IN_EPADDR1,// should we put the adress that we found before ? 
			.Attributes             = (EP_TYPE_INTERRUPT | ENDPOINT_ATTR_NO_SYNC | ENDPOINT_USAGE_DATA),// look for the right attributes 
	...
	.PAD_ReportINEndpoint2 =
		{
			...
			.EndpointAddress        = PAD_IN_EPADDR2,// should we put the adress that we found before ? 
			.Attributes             = (EP_TYPE_INTERRUPT | ENDPOINT_ATTR_NO_SYNC | ENDPOINT_USAGE_DATA),// look for the right attributes 
			.EndpointSize           = PAD_EPSIZE,
			.PollingIntervalMS      = 0x05
		},
	.PAD_ReportOUTEndpoint1 =
		{
			...
			.EndpointAddress        = PAD_OUT_EPADDR1,// same , should we put the adress we put before
	...
	.PAD_ReportOUTEndpoint2 =
		{
			...
			.EndpointAddress        = PAD_OUT_EPADDR2,// same , should we put the adress we put before
			.Attributes             = (EP_TYPE_INTERRUPT | ENDPOINT_ATTR_NO_SYNC | ENDPOINT_USAGE_DATA),
			.EndpointSize           = PAD_EPSIZE,
			.PollingIntervalMS      = 0x05
		}
